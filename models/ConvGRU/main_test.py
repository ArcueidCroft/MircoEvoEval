...
def test():
    ...
    checkpoint_path = os.path.join(save_dir, 'checkpoint_best.pth.tar')
    assert os.path.exists(checkpoint_path), f"didn't find: {checkpoint_path}"
