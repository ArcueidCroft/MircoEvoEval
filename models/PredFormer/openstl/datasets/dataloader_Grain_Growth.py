...
class SlidingWindowDataset(Dataset):
    ...
    def __init__(self, data, pre_seq_len=10, aft_seq_len=50, stride=10,data_name='Dendrite_growth'):
        super().__init__()
        self.pre_seq_len = pre_seq_len
        self.aft_seq_len = aft_seq_len
        self.stride = stride
...
class LongSequenceDataset(Dataset):
    def __init__(self, data, pre_seq_len=10, aft_seq_len=90, stride=10):
        super().__init__()
...
def load_data(batch_size, val_batch_size, data_root, 
    ...
    #train = np.load(os.path.join(data_root, 'Dendrite_growth/train.npz'))['data']
