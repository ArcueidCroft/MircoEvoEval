...
class SlidingWindowDataset(Dataset):
    ...
    def __init__(self, data, pre_seq_len=10, aft_seq_len=10, stride=4,data_name='Dendrite_growth'):
        super().__init__()
        self.pre_seq_len = pre_seq_len
        self.aft_seq_len = aft_seq_len
        self.stride = stride
...
def load_data(batch_size, val_batch_size, data_root, 
              stride=4, num_workers=4, pre_seq_length=None, aft_seq_length=None,in_shape=None,distributed=False,use_augment=False,
    ...
    train_set = OriginalDataset(train, pre_seq_length, aft_seq_length , stride     )       
