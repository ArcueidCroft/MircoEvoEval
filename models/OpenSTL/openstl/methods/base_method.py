...
class Base_method(l.LightningModule):
    ...
    def __init__(self, **args):
        ...
        if 'weather' in args['dataname']:
            ...
            self.metric_list, self.spatial_norm, self.channel_names = args['metrics'], True, None
    ...
    def on_test_epoch_end(self):
        ...
        results_all['metrics'] = np.array([eval_res['mae'], eval_res['mse'],eval_res['ssim']])
        # results_all['metrics'] = np.array([eval_res['mae'], eval_res['mse'],eval_res['rmse'],eval_res['ssim']])
