...
def load_data(batch_size, val_batch_size, data_root, 
    ...
    # # ! Spindol
    print('spin')
    train = np.load(os.path.join(data_root, 'Spinodal_decomposition/train.npy'))  # [N, T, H, W]
    val = np.load(os.path.join(data_root, 'Spinodal_decomposition/valid.npy')) 
    test = np.load(os.path.join(data_root, 'Spinodal_decomposition/test.npy'))
