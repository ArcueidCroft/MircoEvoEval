...
def load_data(batch_size, val_batch_size, data_root, 
    ...
    # # ! Plane 
    print('plane')
    train = np.load(os.path.join(data_root, 'Plane_wave_propagation/train.npy'))  # [N, T, H, W]
    val = np.load(os.path.join(data_root, 'Plane_wave_propagation/valid.npy')) 
    test = np.load(os.path.join(data_root, 'Plane_wave_propagation/test.npy')) 
    train = train[:,:,:,:,0]
    val = val[:,:,:,:,0]
    ...
    # ! Dendrite
    # print('den')
    # train = np.load(os.path.join(data_root, 'Dendrite_growth/train.npz'))['data']  # [N, T, H, W]
    # val = np.load(os.path.join(data_root, 'Dendrite_growth/valid.npz'))['data'] 
    # test = np.load(os.path.join(data_root, 'Dendrite_growth/test.npz'))['data']
