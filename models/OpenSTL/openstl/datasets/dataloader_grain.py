...
def load_data(batch_size, val_batch_size, data_root, 
    ...
    # # ! Grain
    print('Grain')
    train = np.load(os.path.join(data_root, 'Grain_growth/train.npy')) # [N, T, H, W]
    val = np.load(os.path.join(data_root, 'Grain_growth/valid.npy'))
    test = np.load(os.path.join(data_root, 'Grain_growth/test.npy'))
